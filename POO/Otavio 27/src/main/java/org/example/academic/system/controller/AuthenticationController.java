 ...
 * autenticação existentes (AC2, AC6, AC9). Reutilizável por qualquer tela
 * JavaFX ou outra camada de apresentação (AC10).</p>
 */
public class AuthenticationController {
     ...
     * usuário autenticado em caso de sucesso (AC2, AC5).
     * Exceções de autenticação são propagadas sem alteração (AC6).
     */
